...
document.getElementById("frmEditar").addEventListener("submit", async e => {
    ...
    if(!id || !Nombre || !Apellido || !Correo){
        ...
        return; //Evita que el código se sida ejecutando
    }
    ...
    if(respuesta.ok){
        alert("El registro fué actualizado con éxito"); //Confirmación
        modalEditar.close(); //Cerramos el modal
        ObtenerIntegrantes(); //Actualizamos la lista para ver cambios
    }
    else{
